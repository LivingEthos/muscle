---
description: Run MUSCLE code review (standard, pressure, auto-fix, plan, hybrid modes)
agent: build
---

Run MUSCLE self-learning code review on the specified target.

Usage:
/muscle-review --target <path> [--mode <mode>] [--severity <level>] [--options...]
...
Examples:
/muscle-review --target ./src
/muscle-review --target ./src --mode pressure
/muscle-review --target ./src --severity high --format json
/muscle-review --target ./src --shadow --intensity exhaustive
