"""
Loop Controller - The heart of SCLE.
...
class LoopController:
    """
    Main loop orchestrator for SCLE.
    ...
    def run(self, streaming_callback: Callable[[str], None] | None = None) -> LoopContext:
        ...
        logger.info(
            f"Starting SCLE session {ctx.session_id}: "
