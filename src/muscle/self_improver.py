"""
Self-Improver - MUSCLE analyzes its own performance and improves.
...
class SelfImprover:
    IMPROVEMENT_LOG = Path.home() / ".muscle" / "improvement_log.json"
    SYSTEM_PROMPTS_DIR = Path.home() / ".muscle" / "prompts"
    ...
    def generate_improved_system_prompt(self) -> str:
        ...
        prompt_parts = [
            "You are MUSCLE, a MiniMax Unified Self-Correcting Learning Engine.",
    ...
    def run_self_review(self) -> str:
        ...
        lines = [
            "=" * 60,
            "MUSCLE Self-Improvement Report",
            "=" * 60,
