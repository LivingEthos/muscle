...
print_plugin_instructions() {
    ...
    printf "    /muscle:doctor     Plugin and lifecycle diagnostics\n"
    printf "    /muscle:savings    Token and command-output savings evidence\n"
    printf "    /muscle:discover   Read-only missed-opportunity discovery\n"
    printf "    /muscle:filters    Trust-gated output filter checks\n"
